...
merged_path = './results-data/merged_low_filter.csv'
polling_path = './results-data/presidential_primary_averages_2024.csv'
sentiment_path = './results-data/sentiment_results'
